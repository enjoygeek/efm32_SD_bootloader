 ...
 ****************************************************************************/
__RAMFUNC_PRE __INLINE void _DEBUGLOCK_driveBit(int bit) __RAMFUNC_POST;
__RAMFUNC_PRE void _DEBUGLOCK_driveBit(int bit)
{
  int i;
  if (bit)
  {
 ...
 ****************************************************************************/
__RAMFUNC_PRE void DEBUGLOCK_startDebugInterface(void)
{
  int bit, byte;
 ...
 ****************************************************************************/
__RAMFUNC_PRE bool DEBUGLOCK_lock(void)
{
