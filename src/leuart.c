 ...
 ******************************************************************************/
__RAMFUNC_PRE void USART_printHex(uint32_t integer)
{
  uint8_t c;
  int     i, digit;
  for (i = 7; i >= 0; i--)
 ...
 *****************************************************************************/
__RAMFUNC_PRE uint8_t USART_rxByte(void)
{
 ...
 * @brief Transmit single byte to BOOTLOADER_USART
 *****************************************************************************/
__RAMFUNC_PRE int USART_txByte(uint8_t data)
{
 ...
 *****************************************************************************/
__RAMFUNC_PRE void USART_printString(uint8_t *string)
{
  while (*string != 0)
  {
    USART_txByte(*string++);
